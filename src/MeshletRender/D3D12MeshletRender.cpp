...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\Tails.bin";
const wchar_t* c_texturePath = L"..\\Assets\\Tails.png";
...
void D3D12MeshletRender::OnUpdate()
{
    ...
    XMMATRIX world = XMMatrixScaling(25, 25, 25)* XMMatrixTranslation(0.0f, 0.0f, 0.0f);
